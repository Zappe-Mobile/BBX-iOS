//
//  BBXTradingPortalViewController.m
//  BBX
//
...
@interface BBXTradingPortalViewController ()
{
...
@implementation BBXTradingPortalViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.titleView = [self.navigationController setTitleView:NSLocalizedString(@"BBX Trading Portal", nil)];
    ...
    [hogan addAttribute:NSFontAttributeName
                  value:[UIFont fontWithName:@"Avenir-Heavy" size:10]
                  range:NSMakeRange(0, 61)];
    
    [hogan addAttribute:NSFontAttributeName
                  value:[UIFont fontWithName:@"Avenir-Heavy" size:9]
