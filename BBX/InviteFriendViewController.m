...
@interface InviteFriendViewController ()
{
    ...
    IBOutlet UITextField * txtEmail3;
    IBOutlet UITextField * txtEmail4;
    IBOutlet UITextField * txtEmail5;
    IBOutlet UITextField * txtSubject;
    IBOutlet EAMTextView * txtEmailBody;
    IBOutlet UIButton * btnEmailSelectedCountry;
    IBOutlet UIButton * btnEmailSelectedLanguage;
    IBOutlet UIScrollView * scrollEmail;
    
    //! SMS
    IBOutlet UITextField * txtNumber1;
    IBOutlet UITextField * txtNumber2;
    IBOutlet UITextField * txtNumber3;
    IBOutlet UITextField * txtNumber4;
    IBOutlet UITextField * txtNumber5;
    IBOutlet EAMTextView * txtSMSBody;
    IBOutlet UIButton * btnSMSSelectedCountry;
    IBOutlet UIButton * btnSMSSelectedLanguage;
    IBOutlet UIScrollView * scrollSMS;
...
- (void)setupFirstView
{
    ...
    scrollEmail.contentSize = CGSizeMake(320, 550);
    
    txtEmailBody.placeholder = @"Email Body";
...
- (void)setupSecondView
{
    ...
    scrollSMS.contentSize = CGSizeMake(320, 500);
    
    txtSMSBody.placeholder = @"SMS Body";
}
...
- (IBAction)byEmailSubmit:(id)sender
{
    if ([[Reachability reachabilityForInternetConnection]isReachable]) {
        ...
        [[RequestManager sharedManager]inviteFriendByEmailWithEmails:txtEmail1.text withSubject:txtSubject.text withBody:txtEmailBody.text withCompletionBlock:^(BOOL result, id resultObject) {
...
- (IBAction)bySMSSubmit:(id)sender
{
    if ([[Reachability reachabilityForInternetConnection]isReachable]) {
        ...
        [SVProgressHUD showWithStatus:@"Loading" maskType:SVProgressHUDMaskTypeBlack];
        [[RequestManager sharedManager]inviteFriendBySMSWithNumbers:txtNumber1.text withBody:txtSMSBody.text withCompletionBlock:^(BOOL result, id resultObject) {
