...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDate *date = [formatter dateFromString:[arrayEventsDateTime objectAtIndex:indexPath.row]];
    [formatter setDateFormat:@"yyyy-MM-dd HH:mm:ssZZZZ"];

    
//    NSDateFormatter *dateFormatter = [[NSDateFormatter alloc] init];
//    [dateFormatter setDateFormat:@"yyyy-mm-dd'T'hh:mm:ss gm"];
//    NSDate *myDate = [dateFormatter dateFromString:[arrayEventsDateTime objectAtIndex:indexPath.row]];
