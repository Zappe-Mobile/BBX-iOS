    ...
    if ([[Reachability reachabilityForInternetConnection]isReachable]) {
        ...
        [[RequestManager sharedManager]getInvestmentSearchWithKeyword:txtKeyword.text withPriceStart:minPriceValue withPriceEnd:maxPriceValue withCategoryId:categoryValue withLanguageId:@"247" withCountryId:@"5" withPageNumber:@"1" withProductsCount:@"100" withCompletionBlock:^(BOOL result, id resultObject) {
            ...
            if (result) {
                ...
                if ([[resultObject objectForKey:@"InvestmentItem"]isKindOfClass:[NSArray class]]) {
                   //! Type Array
                    [DataManager storeInvestmentSearchData:[resultObject objectForKey:@"InvestmentItem"] dataDictionary:nil DataBlock:^(BOOL success, NSError *error) {
                        
                        if (success) {
                            
                            InvestmentSearchResultsViewController * searchObj = [[InvestmentSearchResultsViewController alloc]init];
                    ...
                    //! Type Dictionary
                    [DataManager storeInvestmentSearchData:nil dataDictionary:[resultObject objectForKey:@"InvestmentItem"] DataBlock:^(BOOL success, NSError *error) {
