//
//  MarketPlaceProductsViewController.m
//  BBX
//
...
@interface MarketPlaceProductsViewController ()
{
...
@implementation MarketPlaceProductsViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.titleView = [self.navigationController setTitleView:NSLocalizedString(@"Marketplace", nil)];
    ...
    for (ProductsPerCategory * Object in [DataManager loadAllMarketPlaceProductsPerCategoryFromCoreData]) {
        ...
        [arrayProductSelImage addObject:Object.image];
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[RequestManager sharedManager]getMarketplaceProductDetailsWithSellId:[arrayProductSelId objectAtIndex:indexPath.row] WithCountryId:[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"] WithCompletionBlock:^(BOOL result, id resultObject) {
...
{
    tblView = nil;
    arrayProductSelId = nil;
    arrayProductSelTitle = nil;
    arrayProductSelImage = nil;
    imageDownloaded = nil;
}
