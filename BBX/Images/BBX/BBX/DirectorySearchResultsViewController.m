...
//    [[RequestManager sharedManager]getMarketplaceProductDetailsWithSellId:[arrayDirectoryResultsPrcId objectAtIndex:indexPath.row] WithCountryId:@"5" WithCompletionBlock:^(BOOL result, id resultObject) {
//
//        if (result) {
//    
//                NSLog(@"%@",resultObject);
