//
//  CurrentMemberBuyHistoryViewController.m
//  BBX
//
...
@interface CurrentMemberBuyHistoryViewController ()
{
...
@implementation CurrentMemberBuyHistoryViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.titleView = [self.navigationController setTitleView:NSLocalizedString(@"Buy History", nil)];
    ...
    for (BuyHistory * Object in [DataManager loadAllBuyHistoryFromCoreData]) {
        ...
        [arrayProductsId addObject:Object.buyId];
