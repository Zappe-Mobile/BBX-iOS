 ...
 *  @param block     Block Returning Success OR Failure
 */
-(void)getAllGiftVouchersByStateId:(NSString *)stateId WithCompletionBlock:(CompletionBlock)block
{
    self.completionBlock = block;
    
    NSString *soapMsg =	[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" "<soap:Body><LifeStyleGetAllVoucherByState xmlns=\"http://tempuri.org/\"><CountryID>%@</CountryID><StateID>%@</StateID><LanguageID>%@</LanguageID><PageNumber>%@</PageNumber><NumberOfProductPerPage>%@</NumberOfProductPerPage></LifeStyleGetAllVoucherByState></soap:Body></soap:Envelope>",[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"],stateId,[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDLANGUAGE"],@"1",@"100"];
	...
	NSString *msgLength = [NSString stringWithFormat:@"%lu", (unsigned long)[soapMsg length]];
	[req addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [req addValue:@"http://tempuri.org/LifeStyleGetAllVoucherByState" forHTTPHeaderField:@"SOAPAction"];
    [req addValue:@"ebbx.com" forHTTPHeaderField:@"Host"];
    [req addValue:msgLength forHTTPHeaderField:@"Content-Length"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSXMLParser class]]) {
            ...
            NSLog(@"%@",[[[[[[dict objectForKey:@"soap:Envelope"]
                             objectForKey:@"soap:Body"]
                            objectForKey:@"LifeStyleGetAllVoucherByStateResponse"]
                           objectForKey:@"LifeStyleGetAllVoucherByStateResult"]
                          objectForKey:@"diffgr:diffgram"]
                         objectForKey:@"NewDataSet"]);
...
-(void)getLifestyleSearchWithText:(NSString *)searchText withCountryId:(NSString *)countryId withLanguageId:(NSString *)languageId withPageNumber:(NSString *)pageNumber withProductCount:(NSString *)productCount WithCompletionBlock:(CompletionBlock)block
{
    ...
    NSString *soapMsg =	[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" "<soap:Body><LifeStyleSearch xmlns=\"http://tempuri.org/\"><Keyword>%@</Keyword><CountryID>%@</CountryID><LanguageID>%@</LanguageID><PageNumber>%@</PageNumber><NumberOfProductPerPage>%@</NumberOfProductPerPage></LifeStyleSearch></soap:Body></soap:Envelope>",searchText,[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"],[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDLANGUAGE"],@"1",@"100"];
	...
	NSString *msgLength = [NSString stringWithFormat:@"%lu", (unsigned long)[soapMsg length]];
	[req addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [req addValue:@"http://tempuri.org/LifeStyleSearch" forHTTPHeaderField:@"SOAPAction"];
    [req addValue:@"ebbx.com" forHTTPHeaderField:@"Host"];
    [req addValue:msgLength forHTTPHeaderField:@"Content-Length"];
...
-(void)getInvestmentSearchWithKeyword:(NSString *)keyword withPriceStart:(NSString *)startPrice withPriceEnd:(NSString *)endPrice withCategoryId:(NSString *)categoryId withLanguageId:(NSString *)languageId withCountryId:(NSString *)countryId withPageNumber:(NSString *)pageNumber withProductsCount:(NSString *)productsCount withCompletionBlock:(CompletionBlock)block
{
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSXMLParser class]]) {
            ...
            NSLog(@"%@",[[[[[[dict objectForKey:@"soap:Envelope"]
                             objectForKey:@"soap:Body"]
                            objectForKey:@"InvestmentSearchResponse"]
                           objectForKey:@"InvestmentSearchResult"]
                          objectForKey:@"diffgr:diffgram"]
                         objectForKey:@"NewDataSet"]);
...
/**
 *  MarketPlace Front Image
 *
 *  @param block Block Returning Success OR Failure
 */
-(void)getMarketPlaceFrontImageWithCompletionBlock:(CompletionBlock)block
{
    self.completionBlock = block;
    
    NSString *soapMsg =	[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" "<soap:Body><MarketPlaceFrontImage xmlns=\"http://tempuri.org/\"><CountryID>%@</CountryID><LanguageID>%@</LanguageID></MarketPlaceFrontImage></soap:Body></soap:Envelope>",[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"],[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDLANGUAGE"]];
	...
	NSString *msgLength = [NSString stringWithFormat:@"%lu", (unsigned long)[soapMsg length]];
	[req addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [req addValue:@"http://tempuri.org/MarketPlaceFrontImage" forHTTPHeaderField:@"SOAPAction"];
    [req addValue:@"ebbx.com" forHTTPHeaderField:@"Host"];
    [req addValue:msgLength forHTTPHeaderField:@"Content-Length"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSXMLParser class]]) {
            ...
            NSLog(@"%@",[[[[[[dict objectForKey:@"soap:Envelope"]
                           objectForKey:@"soap:Body"]
                          objectForKey:@"MarketPlaceFrontImageResponse"]
                         objectForKey:@"MarketPlaceFrontImageResult"]
                  objectForKey:@"diffgr:diffgram"]
                  objectForKey:@"NewDataSet"]);
...
/**
 *  MarketPlace Front Image Link One
 *
 *  @param block Block Returning Success OR Failure
 */
-(void)getMarketplaceDetailForImageLinkOneWithCompletionBlock:(CompletionBlock)block
{
    self.completionBlock = block;
    
    NSString *soapMsg =	[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" "<soap:Body><MarketPlaceFrontImageLink1 xmlns=\"http://tempuri.org/\"><CountryID>%@</CountryID><PageNumber>%@</PageNumber><NumberOfProductPerPage>%@</NumberOfProductPerPage></MarketPlaceFrontImageLink1></soap:Body></soap:Envelope>",[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"],@"1",@"100"];
	...
	NSString *msgLength = [NSString stringWithFormat:@"%lu", (unsigned long)[soapMsg length]];
	[req addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [req addValue:@"http://tempuri.org/MarketPlaceFrontImageLink1" forHTTPHeaderField:@"SOAPAction"];
    [req addValue:@"ebbx.com" forHTTPHeaderField:@"Host"];
    [req addValue:msgLength forHTTPHeaderField:@"Content-Length"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSXMLParser class]]) {
            ...
            NSLog(@"%@",[[[[[[dict objectForKey:@"soap:Envelope"]
                             objectForKey:@"soap:Body"]
                            objectForKey:@"MarketPlaceFrontImageLink1Response"]
                           objectForKey:@"MarketPlaceFrontImageLink1Result"]
                          objectForKey:@"diffgr:diffgram"]
                         objectForKey:@"NewDataSet"]);
...
/**
 *  MarketPlace Front Image Link Two
 *
 *  @param block Block Returning Success OR Failure
 */
-(void)getMarketplaceDetailForImageLinkTwoWithCompletionBlock:(CompletionBlock)block
{
    self.completionBlock = block;
    
    NSString *soapMsg =	[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" "<soap:Body><MarketPlaceFrontImageLink2 xmlns=\"http://tempuri.org/\"><CountryID>%@</CountryID><PageNumber>%@</PageNumber><NumberOfProductPerPage>%@</NumberOfProductPerPage></MarketPlaceFrontImageLink2></soap:Body></soap:Envelope>",[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"],@"1",@"100"];
	...
	NSString *msgLength = [NSString stringWithFormat:@"%lu", (unsigned long)[soapMsg length]];
	[req addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [req addValue:@"http://tempuri.org/MarketPlaceFrontImageLink2" forHTTPHeaderField:@"SOAPAction"];
    [req addValue:@"ebbx.com" forHTTPHeaderField:@"Host"];
    [req addValue:msgLength forHTTPHeaderField:@"Content-Length"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSXMLParser class]]) {
            ...
            NSLog(@"%@",[[[[[[dict objectForKey:@"soap:Envelope"]
                             objectForKey:@"soap:Body"]
                            objectForKey:@"MarketPlaceFrontImageLink2Response"]
                           objectForKey:@"MarketPlaceFrontImageLink2Result"]
                          objectForKey:@"diffgr:diffgram"]
                         objectForKey:@"NewDataSet"]);
...
/**
 *  MarketPlace Front Image Link Three
 *
 *  @param block Block Returning Success OR Failure
 */
-(void)getMarketplaceDetailForImageLinkThreeWithCompletionBlock:(CompletionBlock)block
{
    self.completionBlock = block;
    
    NSString *soapMsg =	[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" "<soap:Body><MarketPlaceFrontImageLink3 xmlns=\"http://tempuri.org/\"><CountryID>%@</CountryID><PageNumber>%@</PageNumber><NumberOfProductPerPage>%@</NumberOfProductPerPage></MarketPlaceFrontImageLink3></soap:Body></soap:Envelope>",[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"],@"1",@"100"];
	...
	NSString *msgLength = [NSString stringWithFormat:@"%lu", (unsigned long)[soapMsg length]];
	[req addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [req addValue:@"http://tempuri.org/MarketPlaceFrontImageLink3" forHTTPHeaderField:@"SOAPAction"];
    [req addValue:@"ebbx.com" forHTTPHeaderField:@"Host"];
    [req addValue:msgLength forHTTPHeaderField:@"Content-Length"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSXMLParser class]]) {
            ...
            NSLog(@"%@",[[[[[[dict objectForKey:@"soap:Envelope"]
                             objectForKey:@"soap:Body"]
                            objectForKey:@"MarketPlaceFrontImageLink3Response"]
                           objectForKey:@"MarketPlaceFrontImageLink3Result"]
                          objectForKey:@"diffgr:diffgram"]
                         objectForKey:@"NewDataSet"]);
...
/**
 *  MarketPlace Front Image Link Four
 *
 *  @param block Block Returning Success OR Failure
 */
-(void)getMarketplaceDetailForImageLinkFourWithCompletionBlock:(CompletionBlock)block
{
    self.completionBlock = block;
    
    NSString *soapMsg =	[NSString stringWithFormat:@"<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">" "<soap:Body><MarketPlaceFrontImageLink4 xmlns=\"http://tempuri.org/\"><CountryID>%@</CountryID><PageNumber>%@</PageNumber><NumberOfProductPerPage>%@</NumberOfProductPerPage></MarketPlaceFrontImageLink4></soap:Body></soap:Envelope>",[[NSUserDefaults standardUserDefaults]objectForKey:@"SELECTEDCOUNTRY"],@"1",@"100"];
	...
	NSString *msgLength = [NSString stringWithFormat:@"%lu", (unsigned long)[soapMsg length]];
	[req addValue:@"text/xml; charset=utf-8" forHTTPHeaderField:@"Content-Type"];
    [req addValue:@"http://tempuri.org/MarketPlaceFrontImageLink4" forHTTPHeaderField:@"SOAPAction"];
    [req addValue:@"ebbx.com" forHTTPHeaderField:@"Host"];
    [req addValue:msgLength forHTTPHeaderField:@"Content-Length"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([responseObject isKindOfClass:[NSXMLParser class]]) {
            ...
            NSLog(@"%@",[[[[[[dict objectForKey:@"soap:Envelope"]
                             objectForKey:@"soap:Body"]
                            objectForKey:@"MarketPlaceFrontImageLink4Response"]
                           objectForKey:@"MarketPlaceFrontImageLink4Result"]
                          objectForKey:@"diffgr:diffgram"]
                         objectForKey:@"NewDataSet"]);
