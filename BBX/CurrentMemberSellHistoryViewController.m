//
//  CurrentMemberSellHistoryViewController.m
//  BBX
//
...
@interface CurrentMemberSellHistoryViewController ()
{
...
@implementation CurrentMemberSellHistoryViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.titleView = [self.navigationController setTitleView:NSLocalizedString(@"Sell History", nil)];
